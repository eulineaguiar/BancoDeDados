...
--
-- Host: localhost    Database: casa_de_apostas
-- ------------------------------------------------------
...
CREATE TABLE `apostas` (
  ...
  CONSTRAINT `apostas_ibfk_1` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`),
  CONSTRAINT `apostas_ibfk_2` FOREIGN KEY (`evento_id`) REFERENCES `eventos` (`id`)
...
-- Dump completed on 2024-06-06 16:53:32
