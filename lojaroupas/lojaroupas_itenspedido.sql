...
--
-- Host: localhost    Database: lojaroupas
-- ------------------------------------------------------
...
CREATE TABLE `itenspedido` (
  ...
  `RoupaID` int DEFAULT NULL,
  `Quantidade` int DEFAULT NULL,
  `PreçoUnitário` decimal(10,2) DEFAULT NULL,
  `Subtotal` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`ItemID`),
  KEY `PedidoID` (`PedidoID`),
  KEY `RoupaID` (`RoupaID`),
  CONSTRAINT `itenspedido_ibfk_1` FOREIGN KEY (`PedidoID`) REFERENCES `pedidos` (`PedidoID`),
  CONSTRAINT `itenspedido_ibfk_2` FOREIGN KEY (`RoupaID`) REFERENCES `roupas` (`RoupaID`)
...
-- Dump completed on 2024-06-06 17:12:48
