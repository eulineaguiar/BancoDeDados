...
CREATE TABLE `passageiros` (
  ...
  `bilhete_comprado_para_voo_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `bilhete_comprado_para_voo_id` (`bilhete_comprado_para_voo_id`),
  CONSTRAINT `passageiros_ibfk_1` FOREIGN KEY (`bilhete_comprado_para_voo_id`) REFERENCES `voos` (`id`)
